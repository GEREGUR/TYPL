const Main = () => {
  return (
    <main className="flex flex-col h-full w-full justify-between items-center pt-20">
      <h1 className="text-xl sm:text-2xl text-center font-bold p-4 text-[#606060]">
        Выберите блок тестирования
      </h1>
      <ul className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-4 p-4 lg:pb-0 w-full h-full">
